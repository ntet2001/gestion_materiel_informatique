...
<body>
    ...
    <div class="nav-side">
        <nav class="nav-navbar">
            <ul>
                ...
                <li>
                    <a href="<?="./template.php?p=utilisateur"?>">
                ...
                <li>
                    <a href="<?="./template.php?p=fournisseur"?>">
                ...
                <li>
                    <a href="<?="./template.php?p=materiel"?>">
                ...
                <li>
                    <a href="<?="./template.php?p=livraison"?>">
                ...
                <li>
                    <a href="<?="./template.php?p=commande"?>">
    ...
    <div class="row contain">
        <?php
            ...
            if ($p == 'client') {
                require '../client/indexClient.php';
            }elseif($p == 'utilisateur'){
                require '../admin/admin.php';
            }elseif($p == 'fournisseur'){
                require '../fournisseur/indexFournisseur.php';
            }elseif($p == 'materiel'){
                require '../materiel/indexMateriel.php';
            }elseif($p == 'facture'){
                ...
                $svg='<h1>Hello! Welcome to your app <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-cloud-sun" viewBox="0 0 16 16">
